...
const CATEGORY_IMAGE: Record<string, string> = {
  ...
  "event-party": "https://images.unsplash.com/photo-1511578314322-379afb476865?w=800",
  "adventure-sports": "https://images.unsplash.com/photo-1551698618-1dfe5d97d256?w=800",
  "prewedding-costumes": "https://images.unsplash.com/photo-1595777457583-95e059d581b8?w=800",
};
...
const TAXONOMY: Record<string, string[]> = {
  ...
  "prewedding-costumes": [
    "Bridal Lehenga (Heavy / Designer)",
    "Light Lehenga (Shoot Wear)",
    "Wedding Gown (White / Pastel)",
    "Evening Gown",
    "Saree (Designer / Silk / Net)",
    "Indo-Western Dress",
    "Crop Top & Skirt Sets",
    "Traditional South Indian Saree Look",
    "Boho Dresses (Beach Shoot Style)",
    "Tuxedo Suit",
    "3-Piece Suit (Formal Shoot)",
    "Ethnic Kurta Pajama Set",
    "Sherwani (Light / Heavy)",
    "Indo-Western Suit",
    "Casual Blazer Look",
    "White Shirt + Suspender Style (Romantic Shoot)",
    "Matching Black & White Theme Outfits",
    "Royal King & Queen Theme Dresses",
    "Traditional Bride & Groom Set",
    "Casual Denim Couple Look",
    "Beach Wear Couple Outfit",
    "Vintage Theme Dress Set",
    "Floral Theme Couple Dress Set",
    "Umbrellas (Clear / Color / Vintage)",
    "Smoke Bombs (Colored Effects)",
    "Artificial Flowers / Bouquets",
    "LED Fairy Lights",
    "Vintage Chairs & Sofa Props",
    "Bicycle (Romantic Theme)",
    "Wooden Frames & Arches",
    "Decorative Heart Props",
    "Ring Props / Engagement Theme Props",
  ],
};
